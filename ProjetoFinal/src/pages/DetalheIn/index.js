...
export default function Detalhe({ navigation,route }) {
    ...
    const reativar = ()=>{
        db.transaction(txn => {
            txn.executeSql(
                `UPDATE clientes SET status=true WHERE id = ${route.params.id}`,
                [],
                (sql,res)=> {
                    console.log("ATIVADO!")
        ...
        return(
            <View>
                ...
                <View style={styles.btns}>
                    <TouchableOpacity style={styles.btnI} onPress={reativar}>
                        <Text style={styles.txtI}>Reativar</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.btnE} onPress={excluir}>
                        <Text style={styles.txtE}>Excluir</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
